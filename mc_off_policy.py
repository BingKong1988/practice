...
def create_random_policy(nA):
    """
    Creates a rendom policy function.
...
def mc_control_importance_sampling(env, num_episodes, behavior_policy, discount_factor=1.0):
    ...
    Returns:
        A tuple (Q, policy).
        Q is a dictionary mapping state to action value.
        policy is a function that takes and observation as an argument and returns action probabilities
        which is the optimal greedy policy.
    """
