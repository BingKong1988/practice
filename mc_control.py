...
def make_epislon_greedy_policy(Q, epsilon, nA):
    """
    ...
    Returns:
        A function that takes the observation as an argument and returns the probabilities
        for each action in the form of a numpy array of length nA.

    """

    def policy_fn(observation):
        A = np.ones(nA, dtype=float) / nA * epsilon
...
def mc_control_epsilon_greedy(env, num_episodes, discount_factor=1.0, epsilon=0.1):
    ...
    Args:
        ...
        num_episodes: Number of eposodes to samle.
    ...
    # We could use an array to save all returns but that's memory inefficient.
    ...
    # The policy that we're following
    policy = make_epislon_greedy_policy(Q, epsilon, env.action_space.n)
    ...
    for i_episode in range(1, num_episodes + 1):
        ...
        for state, action in sa_in_episode:
            ...
            # Finde the first occurance of the (state, action) pair in the episode
        ...
        # The policy is imporved implicitly by changing the Q dictionary
...
if __name__ == '__main__':
    ...
    # For flotting: Create value function from action-value function
